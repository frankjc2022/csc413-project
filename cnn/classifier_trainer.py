...
if __name__ == '__main__':
    ...
    dataset = ImageFolder('Train_9G/Train', transform=None)
    ...
    model = RoomTypeCNN(7, transfer_learning=True)
    lr = 0.0001
    num_epochs = 20
    save_epoch = 2
    weight_decay = 0.0001
    ...
    model.load_state_dict(torch.load('logs/20240416-012640/model_16.pth'))
